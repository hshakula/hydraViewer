    ...
    if( NOT "${_args_FILES}" STREQUAL "")
        ...
        foreach (f ${_args_FILES})
            ...
            add_custom_command(
                ...
                COMMAND ${CMAKE_COMMAND} -Dinfile="${infile}" -Doutfile="${outfile}" -P "${PROJECT_SOURCE_DIR}/cmake/usd_cmake/macros/copyHeaderForBuild.cmake"
    ...
    foreach(file ${ip_FILES})
        ...
        if (${file} MATCHES ".py$")
            ...
            add_custom_command(OUTPUT ${outfile}
                COMMAND
                    ${PYTHON_EXECUTABLE}
                    ${PROJECT_SOURCE_DIR}/cmake/usd_cmake/macros/compilePython.py
